...
import itsamysterious.mods.reallifemod.core.blocks.furniture.BlockChair;
import itsamysterious.mods.reallifemod.core.blocks.furniture.BlockDartboard;
import itsamysterious.mods.reallifemod.core.blocks.furniture.BlockShelf;
...
public class RealLifeMod_Blocks {
	...
	public static void defineBlocks() {
		...
		blockList.add(tarmac = new BlockTarmac(Material.rock).setUnlocalizedName("blocktarmac")
		...
		blockList.add(tvtable = new BlockTVTable());
		blockList.add(shelf = new BlockShelf());
