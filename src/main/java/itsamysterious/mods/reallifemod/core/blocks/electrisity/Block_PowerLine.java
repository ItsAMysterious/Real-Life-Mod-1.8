...
public class Block_PowerLine extends RLMBlockContainer{
	
	public Block_PowerLine() {
		super(Material.iron);
		setUnlocalizedName("blockPowerLine");
		setCreativeTab(RealLifeMod.Technologie);
		GameRegistry.registerBlock(this, getUnlocalizedName().substring(5));
		this.dimensions=new int[]{-4,0, -4, 4, 15, 4};
	}
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntity_PowerLine();
	}
